...
////      ==============
//            self.indicator = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 70, 40)];
//            self.indicator.contentMode = UIViewContentModeScaleAspectFill;
...
//            
//            //设置动画数组
//            [(UIImageView *)self.indicator setAnimationImages:imgArray];
//            //设置动画播放次数
