...
- (void)checkSelectArticleCharnels{
    ...
    self.CDManger = [CoreDataManger shareCoreDataManger];
       ...
       NSArray * arr1 = [self.CDManger checkSelectArticleCharnel];

       NSArray * arr2 = [self.CDManger checkUnSelectArticleCharnel];
    
       self.selectArr = [NSMutableArray arrayWithArray:arr1];
       self.unSelectArr = [NSMutableArray arrayWithArray:arr2];
...
- (NSArray *)selTitle{
    ...
    for (articleClassModel * model in self.selectArr) {
...
- (NSArray *)unSelTitle{
    ...
    for (articleClassModel * model in self.unSelectArr) {
...
//    articleClassModel * model = self.selectArr[0];
//    self.fistBtTag = [model.c_id integerValue] + 2200;
